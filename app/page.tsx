...
>
  ...
  >
    ...
    <motion.a
      ...
      whileHover={{ scale: 1.05 }}
      whileTap={{ scale: 0.95 }}
      className="flex items-center justify-center gap-2 px-8 py-3  bg-gray-700 text-white rounded-full shadow-sm hover:bg-gray-800 transition-all w-full sm:w-auto"
    >
      <Mail size={20} />
      {t.sendMessage}
    </motion.a>
